...
class BsdsDataset(data.Dataset):
    def __init__(self, dataset_dir='./data/HED-BSDS', split='train', logger=None):
    ...
    def __getitem__(self, index):
        ...
        if self.split == "train":
            ...
            # if self.logger:
            #     self.logger.write("{} edge shape: {}".format(edge_path, edge.shape))
        ...
        # if self.logger:
        #     self.logger.write("{} image shape: {}".format(image_path, image.shape))
